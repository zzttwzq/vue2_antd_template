 ...
 */
export function importXLSX(file, success) {
        ...
        if (keyList.indexOf(it3.fieldName) > -1) {
          ...
          if (isRealNum(it3.fieldValue)) {
            ...
            if (it3.wordFormat == 0) {
              ...
              sumData[it3.fieldName].fieldValue =
                Number(sumData[it3.fieldName].fieldValue) +
                Number(it3.fieldValue);
            } else if (it3.wordFormat == 2 || it3.wordFormat == 3) {
              if (typeof it3.fieldValue == 'string') {
